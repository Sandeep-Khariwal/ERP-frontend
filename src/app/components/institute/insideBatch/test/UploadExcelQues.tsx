...
export default function UploadExcelQues({
  ...
  const handleUploadQuestions = () => {
    ...
    reader.onload = (e: any) => {
        ...
        const options = [
          {
            name: item["Option 1"],
            answer:
              String(item["Option 1 Is Correct"]).toLowerCase().trim() ===
              "true",
          },

          {
            name: item["Option 2"],
            answer:
              String(item["Option 2 Is Correct"]).toLowerCase().trim() ===
              "true",
          },

          {
            name: item["Option 3"],
            answer:
              String(item["Option 3 Is Correct"]).toLowerCase().trim() ===
              "true",
          },

          {
            name: item["Option 4"],
            answer:
              String(item["Option 4 Is Correct"]).toLowerCase().trim() ===
              "true",
          },
        ];

        // correct option nikalna
        const correctOption = options.find((opt) => opt.answer === true);
      ...
      console.log("FINAL QUESTIONS PAYLOAD :", finalPayload);
      ...
      CreateExcelAllQues(finalPayload)
        .then((res: any) => {
          ...
          SuccessNotification("Questions uploaded successfully");
        ...
        .catch((err: any) => {
          ...
          ErrorNotification("Failed to upload questions");
