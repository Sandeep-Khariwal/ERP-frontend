...
// import { MANAGEMENT_REASONS, ManagementReason, Teacher, Timetable } from "./timetable.types";
// import { BulkCreateClassManagement, CreateClassManagement, GetFreeTeachers, GetAllClassManagement } from "@/axios/timetable/classManagement.api";
...
//   // NEW: track whether this timetable/date already has a substitute assigned
//   const [existingManagement, setExistingManagement] = useState<any>(null);
...
//   // NEW: Check if this timetable already has a substitute assigned on the selected date
//   useEffect(() => {
//     if (!timetable || !singleDate) {
//       setExistingManagement(null);
//       return;
//     }

//     setCheckingExisting(true);

//     const dateStr = singleDate.toISOString().slice(0, 10);
...
//     })
//       .then((res: any) => {
//         console.log("EXISTING MANAGEMENT CHECK 👉", res);

//         const records = res?.data || [];
//         setExistingManagement(records.length > 0 ? records[0] : null);
//       })
//       .catch((err: any) => {
//         console.log("EXISTING MANAGEMENT CHECK ERROR ❌", err);
...
//       });
//   }, [timetable, singleDate]);

//   const availableTeachers = teachers.filter(
//     (t) => freeTeacherIds.includes(t._id) && t._id !== timetable?.teacherId
//   );

//   // NEW: resolve the substitute's display name for the warning banner,
//   // falling back to the teachers list if the API only returns an id
//   const existingSubstituteName =
//     existingManagement?.substituteTeacherName ??
//     teachers.find((t) => t._id === existingManagement?.substituteTeacherId)?.name ??
//     existingManagement?.substituteTeacherId;
...
//           {/* NEW: existing-assignment warning */}
//           {checkingExisting && (
//             <Text size="xs" c="dimmed">Checking existing assignment...</Text>
//           )}
//           {!checkingExisting && existingManagement && (
//             <Alert color="orange" variant="light" p="xs" mt={2}>
//               <Text size="xs">
//                 ⚠️ This teacher is already on leave for this date. Substitute already
//                 assigned: <strong>{existingSubstituteName}</strong>
//               </Text>
//             </Alert>
//           )}
//         </Stack>
