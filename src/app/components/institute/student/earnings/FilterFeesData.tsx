...
import { Button, Card, Flex, Grid, LoadingOverlay, Stack, Text, TextInput } from "@mantine/core";
...
const totalPages = Math.ceil(
  FilterFeesStudents.length / itemsPerPage
);
