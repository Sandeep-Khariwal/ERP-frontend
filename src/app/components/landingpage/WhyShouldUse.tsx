...
const WhyShouldUse: React.FC = () => {
  ...
  return (
    <Flex ref={containerRef} p={"10% 10% 5% 10%"} gap={"3.5rem"} direction={"column"}>
      <Group gap={"xl"} className="animate-item">
        <Box w={"55%"}>
          <Text
            style={{
              fontWeight: 800,
      ...
      <Flex justify={"center"} className="animate-item">
        <Button
          ...
          style={{
            padding: "0 5rem",
            fontSize: "1.05rem",
            background: "linear-gradient(to right, #5668F8, #0599FB)",
          }}
        >
          Get Started
        </Button>
