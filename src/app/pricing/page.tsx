...
import { GetAllSubscriptionPlans } from "@/axios/shikshapay/shikshapayApi";
...
export default function SubscriptionPlans() {
      ...
      handler: function (response: any) {
        ...
        PaymentVerification(
          ...
          .then((x) => {
            ...
            UpdateSubscription(adminId, subscrriptionId) //authState._id,subscriptionMonths,amount
              .then((x: any) => {
  ...
  return (
    ...
    >
      ...
      >
        {allSubscriptions.map((plan, i: number) => (
          <Box
            key={plan._id}
            style={(theme) => ({
          ...
          >
            ...
            <Flex w={"100%"} align={"center"} justify={"space-between"}>
              <Text mt="sm" fw={700} fz="lg">
                ...
                <Text component="span" fz="sm" c="dimmed">
                  / {plan.plans.duration.slice(2)}
                </Text>
              </Text>

              <Text mt="sm" fw={700} fz="lg" c={"dimmed"} td="line-through">
               Rs {plan.plans.discountPrice}{" "}
              </Text>
            </Flex>
            ...
            <Button
              w={"100%"}
              onClick={() =>
                paymentHandler(plan.plans.price, plan._id, i)
              }
              style={{
                backgroundColor: "#6c5ce7",
                color: "white",
