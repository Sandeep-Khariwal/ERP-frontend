...
<html lang="en">
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Great+Vibes&family=Cinzel:wght@400;700;900&family=Playfair+Display:wght@400;600;700&family=Montserrat:wght@400;600;700;800&display=swap"
      rel="stylesheet"
    />
    <style>
      *,
  ...
  <body>
    <div class="cert-wrap">
      ...
      >
        ...
        <path
          d="M 0,0 L 110,0 C 85,0 60,8 40,22 C 20,36 8,55 0,85 L 0,50 C 0,25 25,0 50,0 Z"
          fill="#8b0000"
        />
        <path
          d="M 70,0 L 140,0 C 115,0 92,8 72,24 C 50,40 34,65 0,120 L 0,85 C 8,55 20,36 40,22 C 60,8 85,0 110,0 Z"
          fill="#c0392b"
        />
        <path
          d="M 130,0 L 150,0 C 125,0 102,10 82,26 C 62,42 45,72 0,140 L 0,120 C 34,65 50,40 72,24 C 92,8 115,0 140,0 Z"
          fill="#d4af37"
        />
        <path
          d="M 142,0 L 165,0 C 140,0 118,10 98,28 C 76,46 56,78 0,160 L 0,140 C 45,72 62,42 82,26 C 102,10 125,0 150,0 Z"
          fill="#1a1a1a"
        />
        <path
          d="M 158,0 L 172,0 C 148,0 126,11 106,29 C 84,48 64,80 0,172 L 0,160 C 56,160 76,46 98,28 C 118,10 140,0 165,0 Z"
          fill="#f5d97a"
        />

        <path
          d="M 794,562 L 744,562 C 769,562 794,537 794,512 Z"
          fill="#111111"
        />
        <path
          d="M 794,562 L 684,562 C 709,562 734,554 754,540 C 774,526 786,507 794,477 L 794,512 C 794,537 769,562 744,562 Z"
          fill="#8b0000"
        />
        <path
          d="M 724,562 L 654,562 C 679,562 702,554 722,538 C 744,522 760,497 794,442 L 794,477 C 786,507 774,526 754,540 C 734,554 709,562 684,562 Z"
          fill="#c0392b"
        />
        <path
          d="M 664,562 L 644,562 C 679,562 692,552 712,536 C 732,520 749,490 794,422 L 794,442 C 760,497 744,522 722,538 C 702,554 679,562 654,562 Z"
          fill="#d4af37"
        />
        <path
          d="M 652,562 L 629,562 C 654,562 676,552 696,534 C 718,516 738,484 794,402 L 794,422 C 749,490 732,520 712,536 C 692,552 669,562 644,562 Z"
          fill="#1a1a1a"
        />

        <path d="M 794,0 L 744,0 C 769,0 794,25 794,50 Z" fill="#111111" />
        <path
          d="M 794,0 L 684,0 C 709,0 732,8 750,24 C 768,40 778,65 794,105 L 794,50 C 794,25 769,0 744,0 Z"
          fill="#8b0000"
        />
        <path
          d="M 724,0 L 664,0 C 689,0 712,8 730,25 C 750,44 762,72 794,135 L 794,105 C 778,65 768,40 750,24 C 732,8 709,0 684,0 Z"
          fill="#c0392b"
        />
        <path
          d="M 674,0 L 656,0 C 680,0 702,9 720,26 C 738,44 752,75 794,145 L 794,135 C 762,72 750,44 730,25 C 712,8 689,0 664,0 Z"
          fill="#d4af37"
        />

        <g>
          <path
            d="M 4,542 Q 45,515 90,542"
            stroke="#b8962e"
            stroke-width="1.5"
            fill="none"
          />
          <path
            d="M 4,530 Q 40,505 80,528"
            stroke="#d4af37"
            stroke-width="1"
            fill="none"
            opacity=".6"
            ...
            <div class="logo-emblem">
              ${
                certificateData.logo
                  ? `<img class="logo-img" src="${certificateData.logo}" alt="Logo" />`
                  : `<div class="logo-text-placeholder">
                      <span class="logo-star">★</span>
                      <span class="logo-rn">${certificateData.instituteName.charAt(0)}</span>
                    </div>`
              }
            </div>
              ...
              ${
                isSignatureUrl
                  ? `<img class="sig-img-element" src="${certificateData.authorizedSignatureName}" alt="Signature" onerror="this.style.display='none'; document.getElementById('sigFallback').style.display='block';" />
                     <span id="sigFallback" class="sig-name-fallback" style="display: none">Authorized Signature</span>`
